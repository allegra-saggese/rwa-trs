"""
cfsva_helpers.py -- dataset-local helpers for the CFSVA pipeline.
...
def _load_translations():
    """value_label_translations.csv next to the code: whole Kinyarwanda labels of the 2009 wave (and any other non-English
    label) -> English; exact match on the whole text, used for variable labels and value labels"""
...
KEY_EXTRA = {"hhid_nisr": ("nisr_household_id", "NISR household identifier as shipped"), "pid_nisr": ("nisr_person_id", "NISR person identifier as shipped"),
             "hhsize": ("household_size", "Household size"), "wt_hh": ("household_weight", "Household weight")}
