"""
04_codebook.py -- EC: generate CODEBOOK.md (+ codebook_<unit>.csv) from the final files.
...
out = ["# EC codebook", "", "Generated by `04_codebook.py` from `3_Final/`. Do not hand-edit; see `DECISIONS.md` for the reasoning.", "",
...
out += codebook("EC_pooled_establishment.dta", "establishment")
(HERE / "CODEBOOK.md").write_text("\n".join(out))
log.info("wrote CODEBOOK.md, codebook_establishment.csv")
