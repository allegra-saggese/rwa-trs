...
clear all
set more off
use wave wt production_kg plot_area_ha using "/Users/matteo/Library/CloudStorage/Dropbox/1-Ongoing Projects/Rwanda - TRS/data/Publicly-Available-NISR/Season-Agriculture-Survey-SAS/3_Final/SAS_pooled_plotcrop.dta", clear
gen long one = 1
gen byte haswt = wt < .
