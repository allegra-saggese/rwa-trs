...
% Searched in order: ../figures/ is the Overleaf project's own folder (Overleaf cannot reach Dropbox);
% the absolute path is the local build. One file compiles in both places.
\graphicspath{{../figures/}{/Users/matteo/Library/CloudStorage/Dropbox/1-Ongoing Projects/Rwanda - TRS/output/figures/tex/}}
