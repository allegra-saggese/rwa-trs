...
so no sector disappears under a park.
...
def main():
    ...
    draw(s, pk, "services_per_1000", "steg_ec2014_services_map.pdf", "Blues")
    draw(s, pk, "tourism_per_1000", "steg_ec2014_tourism_map.pdf", "Oranges")
