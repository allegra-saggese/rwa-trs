...
in current dollars. Park revenue is shown in levels; national tourism revenue as the cumulative change
since 2008, the first year the series exists. Visits and arrivals are levels on the left axis.
...
def main():
    ...
    draw(pv / 1e3, "National park visits, thousands (left)", lambda v, _: f"{v:,.0f}", preal / 1e0,
