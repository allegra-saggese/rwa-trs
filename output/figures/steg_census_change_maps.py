...
drawn as in steg_ec_maps.py. Tried and dropped: -5 to +5 pooled into one grey class, four classes cut at
-10, 0 and +10, a red-green split at the median on each side of zero, and quartiles in blue (with a
manufacturing map).
"""
import sys
